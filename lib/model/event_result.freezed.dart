  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.results_start, results_start) ||
                other.results_start == results_start) &&
            (identical(other.results_returned, results_returned) ||
                other.results_returned == results_returned) &&
            (identical(other.results_available, results_available) ||
                other.results_available == results_available) &&
            const DeepCollectionEquality().equals(other.events, events));
  }

  @override
  int get hashCode => Object.hash(runtimeType, results_start, results_returned,
      results_available, const DeepCollectionEquality().hash(events));
